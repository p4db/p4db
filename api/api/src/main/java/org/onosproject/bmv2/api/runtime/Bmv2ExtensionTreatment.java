...
public final class Bmv2ExtensionTreatment extends AbstractExtension implements ExtensionTreatment {
    ...
    private static Logger log = LoggerFactory.getLogger(Bmv2ExtensionTreatment.class);
    ...
    public static final class Builder {
        ...
        public Bmv2ExtensionTreatment build() {
            ...
            List<ImmutableByteSequence> newParameters = new ArrayList<>();
            List<String> parameterNames = new ArrayList<>();

            for (int i = 0; i < parameters.size(); i++) {
                newParameters.add(null);
            ...
            for (String parameterName : parameters.keySet()) {
                ...
                try {
                    ...
                    newParameters.set(idx, newSequence);
                    parameterNames.set(idx, parameterName);
