...
public class Bmv2DeviceContextServiceImpl implements Bmv2DeviceContextService {
    ...
    private static final long CHECK_INTERVAL = 500_000; // milliseconds
    ...
    private Map<DeviceId, Bmv2DeviceContext> contexts;
    ...
    public void activate() {
        ...
        this.contexts = Maps.newConcurrentMap();
                /*
                storageService.<DeviceId, Bmv2DeviceContext>consistentMapBuilder()
    ...
    public Bmv2DeviceContext getContext(DeviceId deviceId) {
        ...
        Bmv2DeviceContext versionedContext = contexts.get(deviceId);
        /*
    ...
    */
    ...
    public void setContext(DeviceId deviceId, Bmv2DeviceContext context) {
        ...
        if (!interpreterClassLoaders.containsKey(context.interpreter().getClass().getName())) {
            ...
            } catch (ConsistentMapException.Timeout t) {
                log.info("Detected timeout on context map");
            }
        }
    }
    ...
    public void setDefaultContext(DeviceId deviceId) {
        ...
        contexts.putIfAbsent(deviceId, defaultContext);
        /*
